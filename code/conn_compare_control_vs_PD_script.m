...
saveFileName = 'conn_before_after_GroupCompHbR'; % CHANGE AS NEEDED!
conn_mat_group_comparison(fileGroup1, fileGroup2, groupNames, saveFileName,...
    alpha, chIdxL, chIdxR);
...
saveFileName = 'conn_before_after_GroupCompHbT'; % CHANGE AS NEEDED!
conn_mat_group_comparison(fileGroup1, fileGroup2, groupNames, saveFileName,...
    alpha, chIdxL, chIdxR);
