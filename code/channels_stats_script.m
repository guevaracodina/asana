...
% This the third script to run (3/3)
...
fprintf('FDR-corrected \n')
fprintf('HbO Peak \t  AUC \t Mean \t \n')
disp([VFT_stats_FDR(:,1) VFT_stats_FDR(:,4) VFT_stats_FDR(:,7)])
fprintf('HbR Peak \t  AUC \t Mean \t \n')
disp([VFT_stats_FDR(:,2) VFT_stats_FDR(:,5) VFT_stats_FDR(:,8)])
fprintf('HbT Peak \t  AUC \t Mean \t \n')
disp([VFT_stats_FDR(:,3) VFT_stats_FDR(:,6) VFT_stats_FDR(:,9)])
